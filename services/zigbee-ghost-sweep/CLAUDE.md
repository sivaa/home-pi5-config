...
| `zigbee_any_device_back_online_alert` | L1b | Recovery email triggered by `zigbee_recovery_confirmed` event from the L1a waiter — only fires for devices that got an L1a offline email |
